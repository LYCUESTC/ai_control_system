...
void DrawROI::changeROIBegin(const QPoint& point)
{
    ...
    else if (dir == DIR_NONE)
    {
        ...
        m_currentROIIndex = (int)m_rois.size(); //更新roi序号
    }
    else
    {
        //鼠标在矩形边缘
...
//    int width = (int)(mousePoint.x() - m_moveStartPoint.x());   //移动的宽度
//    int height = (int)(mousePoint.y() - m_moveStartPoint.y());  //移动的高度
